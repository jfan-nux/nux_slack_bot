...
WITH experiment AS (
    ...
    WHERE 1=1
    AND a.experiment_name = 'should_pin_leaderboard_carousel'
    AND convert_timezone('UTC', 'America/Los_Angeles', a.exposure_time)::date >= '2025-08-21'
...
, device_level_temp AS (
  ...
  WHERE scd_start_date >= '2025-08-21'
