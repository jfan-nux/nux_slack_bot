...
WHERE convert_timezone('UTC','America/Los_Angeles',iguazu_timestamp) BETWEEN '2025-08-25' AND '2025-09-30'
)
...
WHERE convert_timezone('UTC','America/Los_Angeles',timestamp) BETWEEN '2025-08-25' AND '2025-09-30'
)
