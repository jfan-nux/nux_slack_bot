...
WHERE convert_timezone('UTC','America/Los_Angeles',iguazu_timestamp) BETWEEN '2025-09-08' AND '2025-10-30'
)
...
WHERE convert_timezone('UTC','America/Los_Angeles',timestamp) BETWEEN '2025-09-08' AND '2025-10-30'
)
