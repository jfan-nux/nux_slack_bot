...
FROM segment_events_raw.consumer_production.order_cart_submit_received a
    ...
    AND convert_timezone('UTC','America/Los_Angeles',dd.created_at) BETWEEN '2025-09-10' AND '2025-10-30'
WHERE convert_timezone('UTC','America/Los_Angeles',a.timestamp) BETWEEN '2025-09-10' AND '2025-10-30'
